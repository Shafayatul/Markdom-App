...
<div class="row">
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('from_time[]') ? 'has-error' : ''}}">
            ...
            {!! Form::time('from_time[]', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    ...
    <div class="col-md-6">
        <div class="form-group {{ $errors->has('to_time[]') ? 'has-error' : ''}}">
            ...
            {!! Form::time('to_time[]', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group add-more-file-div"></div>
