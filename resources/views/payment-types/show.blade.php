        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="{{ url('/payment-types/' . $paymenttype->id . '/edit') }}" title="Edit PaymentType"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                    {!! Form::open([
                        'method'=>'DELETE',
                        'url' => ['payment-types', $paymenttype->id],
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {{ $paymenttype->payment_type_arabic }} </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
