        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a href="{{ url('/worker-orders') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                    <br />
                    <br />
                    ...
                    {!! Form::open(['url' => '/worker-submit-reviews', 'files' => true]) !!}
