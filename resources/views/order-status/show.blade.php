            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open([
                            'method'=>'DELETE',
                            'url' => ['orderstatus', $orderstatus->id],
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Order Status </th><td> {{ $orderstatus->order_status }} </td></tr><tr><th> Order Status Arabic </th><td> {{ $orderstatus->order_status_arabic }} </td></tr>
                                </tbody>
                            </table>
                        </div>
