            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/order-status', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Order Status</th><th>Order Status Arabic</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($orderstatus as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->order_status }}</td><td>{{ $item->order_status_arabic }}</td>
                                        <td>
