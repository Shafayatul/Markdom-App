                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <th> Module </th>
                                        <td>
                                            @isset($modules[$servicesubcategory->module_id]) 
                                                {{ $modules[$servicesubcategory->module_id] }}
                                            @endisset 
                                        </td>
                                    </tr>
                                    <tr>
                                        <th> Store </th>
                                        <td>
                                            @isset($stores[$servicesubcategory->store_id]) 
                                                {{ $stores[$servicesubcategory->store_id] }}
                                            @endisset 
                                        </td>
                                    </tr>
                                    <tr>
