@extends('layouts.app')
@section('title')
Edit ServiceSubCategory #{{ $servicesubcategory->id }}
@endsection
@section('content')
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::model($servicesubcategory, [
                        'method' => 'PATCH',
                        'url' => ['/service-sub-categories', $servicesubcategory->id],
                        'files' => true
                    ]) !!}

                    @include ('service-sub-categories.form', ['formMode' => 'edit'])
