     ...
     <div class="rectangle-div">
      <div id="grid">
        @foreach($service_sub_categories as $service_sub_category)
          <a href="{{ route('service-sub-sub-by-service-sub-category', ['id' => $service_sub_category->id]) }}" class="rectangle-box-a" style="background-image: url('{{ asset(env('MAIN_HOST_URL').$service_sub_category->preview_image) }}');">
