  ...
  <div class="container">
    <div class="rectangle-div">
      <div id="grid">
        ...
        <a href="{{ route('service-sub-category-worker', ['id' => $service_category->id]) }}" class="rectangle-box-a" style="background-image: url('{{ asset(env('MAIN_HOST_URL').$service_category->preview_image) }}');">
